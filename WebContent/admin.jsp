    ...
    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class=" border m-5 " style ="border:5px">
			<table class="table table-striped ">
			<thead class="bg-info text-white text-center">
			<h3 class = "text-center">Xác Nhận Hóa Đơn</h3>
			<tr>
			...
			%>
				<tr class="text-center">
					...
					<td ><a href="daxacnhanController?mct=<%=xn.getMachitiethd()%>" class="btn btn-success">Xác Nhận</a></td>
				</tr>
