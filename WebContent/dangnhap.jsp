...
<body>
  ...
  <div class = "row">
  	...
  	<div class="card">
					<div class="card-body">
						...
						<form action="dangnhapController" method="post">
							...
							<div class="text-center ">
								<p><small>Đăng nhập với quyền quản lý cửa hàng?</small><a href="dangnhapadminController"><small>Admin</small></a></p>
  	...
  	<div class = "col-lg-6 mt-5 mt-lg-0">
  				...
  				<p>Bằng cách tạo tài khoản , bạn có thể thanh toán hóa đơn , xem và theo dõi đơn hàng của bạn , còn chờ gì nữa hãy  </p>
  				
  				<a href="dangkyController"><div class="text-center">
